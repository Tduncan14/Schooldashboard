        ...
        <div className="flex items-center justify-between p-4">
            ...
            <div className=" flex  items-center gap-6 justify-end w-full">
                ...
                <div className="bg-white rounded-full w-7 h-7 flex justify-center items-center cursor-pointer relative">
                    ...
                    <div className="absolute -top-3 -right-3 w-5 h-5 flex items-center justify-end bg-purple-500 rounded-full text-sm  text-white">
                        1
                    </div>
                </div>

                <div className="flex flex-col">
                    <span className="text-xs leading-3 font-medium">Treek</span>
